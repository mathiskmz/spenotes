...
ActiveRecord::Schema[8.1].define(version: 2026_05_20_141402) do
  ...
  create_table "bilans", force: :cascade do |t|
    ...
    t.index ["patient_id"], name: "index_bilans_on_patient_id"
    t.index ["user_id"], name: "index_bilans_on_user_id"
  end
  ...
  add_foreign_key "bilans", "patients"
  add_foreign_key "bilans", "users"
